export const personalInfo = {
  ...
  currentRoles: ["Biomedical Engineering Student at Technion", "Software Engineer"],
  ...
  heroDescription: `I am a recent graduate from the Technion - Israel Institute of Technology, where I pursued a degree in Biomedical Engineering. I have a sharp, inquisitive mind, always looking for clever, out-of-the-box ways to approach challenges. I love the process of solving complex problems and building innovative solutions.
I have a strong background in software development, mechanical design, and electronic circuit design.`,
};
...
export const workExperience = [
  ...
  },
  {
    ...
    achievements: ["Built a 3D printed robotic gripper for reliable handling of salmon fillets", "Programmed an Arduino Nano in C++ to control motors and driver circuits"],
  },
];
...
export const skills = [
  {
    ...
    skills: ["C", "C++", "Rust", "Go", "Python", "MATLAB", "TypeScript", "Linux", "ROS2", "Git"],
  },
  {
    category: "Web Development",
    skills: ["HTML", "CSS", "React", "Svelte", "SolidJS", "Tailwindcss", "Node.js/Bun/Deno", "Flask", "Firebase Realtime Database"],
  },
  {
    category: "3D Modeling",
    skills: ["Creo", "SOLIDWORKS", "Onshape", "Blender", "Rhino", "Grasshopper"],
  },
  {
...
export const projects = [
  {
    ...
    description: `As the co-lead of the autonomous team, I spearheaded the design and implementation of the autonomous systems for a Formula-style race car.
...
Additionally, I coded the team's public-facing website, significantly enhancing our visibility and outreach.`,
  },
  {
    ...
    description: "A video cutting application in C++ to help the coach of the Israeli Olympic windsurfing team in reviewing athlete footage",
  },
  {
    ...
    description: "An algorithm for detecting the horizon in images, useful for autonomous vehicles, drone navigation, and data analysis in sports.",
  },
  {
    title: "Zombie Party",
    ...
    description: "A web-RTC based multiplayer game where players control a warrior with their phone's gyroscope and try to survive against waves of zombies. Built entirely in flutter.",
  },
  {
    title: "Shab-BOT",
    ...
    description: `A command-driven bot that interfaces over Whatsapp, complete with a reminder system, scheduled messages, and a quick way to find Shabbat Candle lighting times for 100,000+ cities.
This was originally written using whatsapp-web.js, but in order to speed it up and reduce memory footprint, I ported it to @whiskeysockets/Baileys, then to Golang's Whatsmeow.`,
  },
  {
    ...
    description: "A 3D printed servo-based parachute launcher for a hybrid solid-gas rocket.",
  },
  {
  ...
  },
  {
    ...
    description: "A 3D printed fountain for zen vibes.",
  },
];
