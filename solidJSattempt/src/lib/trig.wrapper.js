/* Trig.js v4.2.0 by iDev Games - Modified for ESM export */
class Trig {
    trigs = [];
    thePos = [];
    height = 0;
...
if (typeof window !== "undefined") {
    ...
    // Note: We don't add 'load' listener here because we want manual control in SPAs
}
